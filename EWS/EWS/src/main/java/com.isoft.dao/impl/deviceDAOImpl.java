...
public class deviceDAOImpl implements deviceDAO {
    ...
    @Override
    public String login(String peopleId, String password, String etype) throws Exception {
        ...
        if (list != null){
            ...
            sqlSession.update(statment,peopleId);
            return "success";}
        else
            return "fault";
    }

    public boolean register(String peopleId, String upwd, String email) {
        SqlSession sqlSession = sessionFactoryBean.openSession(true);
        String statement = "com.isoft.mapping.userMapper.register";
        Map map = new HashMap();
        map.put("uname", peopleId);
        map.put("upwd", upwd);
        map.put("email", email);
